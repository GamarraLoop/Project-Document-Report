...
| **US05** | Carga de imagen de lote de tela | Como Tallerista, quiero tomar una foto de mis retazos de tela para publicar el lote en la plataforma. | **Dado** que un tallerista inicia la publicación de un lote<br>**Cuando** el tallerista proporciona una fotografía nítida de los textiles<br>**Entonces** el sistema almacena temporalmente la imagen y la envía a procesar. | EP02 |
| **US06** | Asignación automática de ubicación | Como Tallerista, quiero que al publicar un lote, mi ubicación actual en Gamarra se asigne automáticamente como el punto de recojo. | **Dado** que un tallerista está publicando un nuevo lote<br>**Cuando** el dispositivo captura las coordenadas GPS actuales<br>**Entonces** el sistema asocia estas coordenadas al lote como el punto exacto de recojo. | EP02 |
| **US07** | Edición manual de ubicación de recojo | Como Tallerista, quiero poder agregar referencias a la ubicación automática (ej. número de stand o galería) para que el artesano me encuentre fácilmente. | **Dado** que el sistema ha asignado una ubicación al lote<br>**Cuando** el tallerista provee texto adicional como referencia de ubicación<br>**Entonces** el sistema adjunta este texto a los datos geográficos del lote. | EP02 |
| **US08** | Cancelación de lote publicado | Como Tallerista, quiero poder cancelar la publicación de mi lote en caso la tela ya no esté disponible. | **Dado** que un tallerista tiene un lote en estado 'Disponible'<br>**Cuando** el tallerista ejecuta la acción de cancelar publicación<br>**Entonces** el sistema actualiza el estado del lote a 'Cancelado' y lo oculta de consultas públicas. | EP02 |
| **US09** | Confirmación de entrega al artesano | Como Tallerista, quiero confirmar en la app que entregué el lote de tela al artesano que vino a recogerlo. | **Dado** que un lote se encuentra en estado 'Reservado'<br>**Cuando** el tallerista emite la confirmación de entrega física<br>**Entonces** el sistema actualiza el estado del lote a 'Entregado' definitivamente. | EP02 |
| **US10** | Extracción de metadatos de imagen | Como Tallerista, quiero que el sistema analice la foto de mi lote para determinar su material automáticamente. | **Dado** que el sistema ha recibido la imagen del lote<br>**Cuando** el sistema procesa la imagen a través del servicio de IA<br>**Entonces** el sistema genera una lista de etiquetas descriptivas sobre el textil. | EP03 |
| **US11** | Presentación de resultados de IA | Como Tallerista, quiero visualizar la categoría en la que fue clasificado mi lote para confirmar si la IA acertó. | **Dado** que el análisis de la imagen del lote finaliza exitosamente<br>**Cuando** el sistema recibe los resultados de clasificación<br>**Entonces** el sistema asocia las etiquetas al lote y las presenta al tallerista antes de la publicación final. | EP03 |
...
| **US16** | Recepción de notificación de reserva | Como Tallerista, quiero recibir una notificación inmediata cuando un artesano reserve mi lote para estar preparado para la entrega. | **Dado** que un artesano reserva un lote exitosamente<br>**Cuando** el sistema backend registra el cambio a estado 'Reservado'<br>**Entonces** el sistema emite una alerta o notificación al dispositivo del tallerista creador del lote. | EP02 |
